...
This framework is highly specialized for creating presentation websites in flash, and probably won't be very useful for anything else. For example if you want to build an application in flash (RIA) you're better of using flex builder. Where this framework shines is for creating sites with a lot of images, a lot less text and not very deep page nesting. So if within those constraints, you're in luck, otherwise seek something else.