package framy.tools {
	...
	public dynamic class Hash extends Object{
		...
		public function with_keys(keys:Array):Hash{
			var h:Hash = new Hash()
			for(var i:uint = 0; i < keys.length; i++){
				h[keys[i]] = this[keys[i]]
			}
			return h
		}
		
		public function diff(other:Hash):Hash{
			var h:Hash = new Hash()
		...
		public function merge(obj:Object, recursive:Boolean=true):Hash {
			for (var name:String in obj) {
				if( obj[name] !== null){
					...
					if (recursive && ( base_class === 'Object' || base_class === "framy.tools::Hash" || base_class === "framy.tools::Options") && ( merge_class === 'Object' || merge_class === "framy.tools::Hash" || merge_class === "framy.tools::Options"))this[name] = new Hash(this[name]).merge(obj[name])
		...
		static public function from_keys_and_values(keys:Array, values:Array):Hash {
