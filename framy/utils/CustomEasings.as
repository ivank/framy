package framy.utils {
	...
	public class CustomEasings {
		...
		public static function init():void {
			...
			Tweener.registerTransition("mellow_smooth", mellow_smooth)
		...
		public static function mellow_smooth (t:Number, b:Number, c:Number, d:Number, p_params:Object = null):Number {
